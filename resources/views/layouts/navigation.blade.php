<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif (auth()->user()->role === 'salesperson')
                        <x-nav-link :href="route('pos.sell')" :active="request()->routeIs('pos.sell')">
                            {{ __('New Sale') }}
                        </x-nav-link>
                    ...
                    @else
                        <x-nav-link :href="route('accounting.transactions.create')" :active="request()->routeIs('accounting.transactions.*')">
                            {{ __('Data Entry') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif (auth()->user()->role === 'salesperson')
                <x-responsive-nav-link :href="route('pos.sell')" :active="request()->routeIs('pos.sell')">
                    {{ __('New Sale') }}
                </x-responsive-nav-link>
            ...
            @else
                <x-responsive-nav-link :href="route('accounting.transactions.create')" :active="request()->routeIs('accounting.transactions.*')">
                    {{ __('Data Entry') }}
                </x-responsive-nav-link>
            @endif
